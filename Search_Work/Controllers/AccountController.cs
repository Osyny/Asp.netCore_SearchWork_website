...
using Search_Work.Models.AccountViewModels;
using Search_Work.Models.ArreaDatabase;
using Search_Work.Services;
using Search_Work.Arrea.Candidate;
using Search_Work.Arrea.Employer;
...
namespace Search_Work.Controllers
{
  ...
  public class AccountController : Controller
  {
    ...
    public AccountController(oxana1404 context,
