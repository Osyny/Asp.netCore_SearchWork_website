...
namespace Search_Work.Data.Migrations
{
    ...
    [Migration("20190210214514_AddFixViewPage")]
    partial class AddFixViewPage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Search_Work.Models.ArreaDatabase.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Search_Work.Models.ArreaDatabase.Resumes.Resume", b =>
                {
                    ...
                    b.Property<bool>("IsActiveResume");

                    b.Property<bool>("IsAnonymousResume");

                    b.Property<bool>("IsHideContact");
            ...
            modelBuilder.Entity("Search_Work.Models.ArreaDatabase.Contact", b =>
                {
                    b.HasOne("Search_Work.Models.ArreaDatabase.Employer", "Employer")
                        .WithOne("Contact")
                        .HasForeignKey("Search_Work.Models.ArreaDatabase.Contact", "EmployerId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
